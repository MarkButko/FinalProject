...
public class MasterProposalsListCommand implements Command {

	private static final Logger LOGGER = LogManager.getLogger(MasterProposalsListCommand.class.getName());
	...
	public MasterProposalsListCommand(ProposalService proposalService) {
		super();
	...
	public String execute(HttpServletRequest request) {
		...
		return user.getRole() == Role.MASTER ? JSPPath.MASTER_PAGE : JSPPath.MANAGER_PAGE;
	}
