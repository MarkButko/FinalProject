...
public final class ServletPath {
	...
	public static final String LOGIN = "/get/login";
	public static final String LOGOUT = "/get/logout";
	...
	public static final String MANAGER_PAGE = "/get/manager/managerProposals";
